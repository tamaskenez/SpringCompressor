...
struct TransferCurvePars {
    ...
    // makeup_gain and reference_level work together: For an input level of `reference_level`
    // the transfer_curve yields a gain of `makeup_gain`. In other words:
    // gain_for_input(reference_level) = makeup_gain.
...
private:
    ...
    double makeup_gain_below_threshold_db = 0;
